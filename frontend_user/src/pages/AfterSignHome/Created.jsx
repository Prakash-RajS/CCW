...
} else if (jobData.project_size) { // Fallback for different API naming
  fetchedEstimateTime = jobData.project_size.charAt(0).toUpperCase() +
    jobData.project_size.slice(1).toLowerCase();
}
...
const submitJob = async (status) => {
  ...
  try {
    ...
    formData.append("project_size", estimateTime.toLowerCase()); // ✅ THIS IS ALREADY THERE
    ...
    // console.log("project_size:", estimateTime.toLowerCase()); // Debug log
