  ...
  return (
    <div id="grow-section">
      <section
        className="
          w-full
          h-[351px] md:h-[82vw] lg:h-[832px]
          flex
          items-start
          justify-start
          pt-[32px] md:pt-[16vw] lg:pt-[40px]
          px-3
          relative
          overflow-hidden
      ...
      >
        ...
        <div
          className="
            ...
            -ml-1 md:max-lg:ml-[8px] mt-22
            w-[80px] md:w-[440px] lg:w-[287px] xl:w-[300px] 2xl:w-[600px]
...
>
  ...
  className="
    ...
    leading-[130%]
    text-[#3D1768]
    max-w-[210px] md:max-w-[33vw] lg:max-w-none
  "
>
  ...
  className="
    ...
    min-w-[82px] sm:min-w-[120px] md:min-w-[110px] lg:min-w-[120px] xl:min-w-[164px] 2xl:min-w-[200px]
    h-[24px] sm:h-[36px] md:h-[34px] lg:h-[32px] xl:h-[42px] 2xl:h-[55px]
    text-[10px] sm:text-[12px] md:text-[12px] lg:text-[14px] xl:text-[18px] 2xl:text-[24px]
    rounded-[6px] sm:rounded-[8px] lg:rounded-[8px] xl:rounded-[10px] 2xl:rounded-[12px]
    px-2 sm:px-3 md:px-3 lg:px-3 xl:px-5 2xl:px-6
  "
>
  Join Talenta
</button>
