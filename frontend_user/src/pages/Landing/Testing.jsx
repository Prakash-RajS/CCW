...
const Testing = () => {
  ...
  return (
    <>
      ...
      <div id="hero-section">
        <section className="w-full h-auto md:h-[1150px] relative overflow-hidden bg-white">
          {/* HEADER */}
          ...
          <div className="absolute top-8 sm:top-0 right-[2%] sm:right-[3%] lg:right-[5%] h-[400px] xs:h-[500px] sm:h-[900px] flex justify-end items-center pointer-events-none">
            <div className="absolute top-8 sm:top-0 right-[15%] sm:right-[20%] lg:right-[25%] h-[400px] xs:h-[500px] sm:h-[900px] flex justify-end items-center pointer-events-none">
              <div className="relative inline-block -translate-y-[100px] xs:-translate-y-[120px] sm:-translate-y-[40px] lg:-translate-y-[100px] xl:-translate-y-[60px] pointer-events-none">
                <div className="absolute inset-0 flex justify-center items-center pointer-events-none">
                  <div className="w-[180px] h-[140px] xs:w-[220px] xs:h-[180px] sm:w-[300px] sm:h-[200px] md:w-[420px] md:h-[280px] lg:w-[600px] lg:h-[280px] rounded-full bg-gradient-to-b from-[#170929] via-[#51218F] to-[#8421FF] blur-[80px] sm:blur-[120px] opacity-80" />
                </div>

                <img
                  src={Collab}
                  alt="Collab illustration"
                  className="relative max-w-none object-contain w-[70vw] xs:w-[65vw] sm:w-[40vw] lg:w-[500px] xl:w-[600px] h-[180px] xs:h-[220px] sm:h-[400px] lg:h-[350px] xl:h-[550px] translate-x-[20px] sm:translate-x-0 opacity-90"
                />

                <svg
                  viewBox="0 0 258 23"
                  xmlns="http://www.w3.org/2000/svg"
                  className="absolute pointer-events-none opacity-50 top-full left-[58%] -translate-x-[50%] sm:left-1/2 sm:-translate-x-1/2 w-[100px] h-[10px] xs:w-[120px] xs:h-[12px] sm:w-[200px] sm:h-[18px] lg:w-[218px] lg:h-[23px]"
                >
                ...
                {[
                  ...
                  <img
                    ...
                    className="absolute hidden lg:block w-[36px] h-[36px] xl:w-[50px] xl:h-[50px] opacity-80 pointer-events-none"
                    style={{ top: pos.top, left: pos.left, transform: `rotate(${pos.rotate})`, animation: `float 6s ease-in-out infinite ${i * 0.4}s` }}
                  />
                ))}
                ...
                {[
                  ...
                  <div
                    key={`pill-${i}`}
                    className={`absolute px-1.5 py-0.5 lg:px-4 lg:py-1.5 text-[6px] xs:text-[7px] lg:text-[13px] font-medium text-white whitespace-nowrap pointer-events-none rounded-full bg-gradient-to-r from-[#6D28D9] to-[#7C3AED] shadow-[0_6px_16px_rgba(124,58,237,0.45)] backdrop-blur-md flex items-center justify-center ${pos.mobile} lg:mt-0 lg:ml-0 lg:w-auto lg:h-auto`}
          ...
          {/* Hero Text */}
          <div className="relative -mt-2 xs:-mt-8 w-[65%] xs:w-[60%] pl-5 xs:pl-8 sm:mt-0 sm:pl-0 sm:absolute sm:top-[50px] sm:left-[3%] lg:left-[4%] xl:left-[5%] sm:w-[576px] flex flex-col gap-2.5 sm:gap-6 text-left z-10">
            <img
              src={Star}
              alt="Star Icon"
              className="w-[16px] h-[16px] xs:w-[18px] xs:h-[18px] sm:w-[60px] sm:h-[60px] relative translate-y-5 translate-x-[10px] xs:translate-y-6 xs:translate-x-0 object-contain self-center sm:self-start sm:translate-y-16 sm:translate-x-[420px] sm:z-10"
              style={{ animation: "spinZoom 4s linear infinite" }}
            />

            <h1 className="text-[24px] leading-[110%] xs:text-[28px] sm:text-[100px] sm:leading-[90%] text-transparent bg-gradient-to-b from-[#170929] to-[#51218F] bg-clip-text whitespace-nowrap" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
              The Future<br />
              of Creative<br />
              Collaboration.
            </h1>

            <p className="text-[8px] leading-[12px] xs:text-[11px] xs:leading-[16px] sm:text-[28px] sm:leading-[45px] text-transparent bg-gradient-to-b from-[#170929] to-[#8421FF] bg-clip-text max-w-[160px] xs:max-w-[200px] sm:max-w-none pr-4 sm:pr-0" style={{ fontFamily: "'Times New Roman', Times, serif", fontWeight: "normal", fontStyle: "normal" }}>
          ...
          {/* CTA Button */}
          <div className="relative w-[65%] xs:w-[60%] mt-3 pl-5 xs:pl-8 sm:mt-0 sm:pl-0 flex flex-row gap-3 sm:absolute sm:top-[650px] sm:left-[3%] lg:left-[4%] xl:left-[5%] sm:w-[528px] sm:flex-row sm:gap-6 z-20">
            <button
              onClick={() => handleNavigate('/signup')}
              className="h-[28px] px-4 text-[10px] rounded-full xs:h-[32px] xs:px-5 xs:text-[11px] sm:h-[58px] sm:px-10 sm:text-[20px] sm:rounded-[18px] font-medium flex items-center justify-center transition-all duration-300 bg-white text-[#51218F] !border border-[#51218F] hover:bg-gradient-to-r hover:from-[#51218F] hover:to-[#170929] hover:text-white hover:shadow-xl active:scale-95"
            >
              Join as Talenta
            </button>
          </div>
          ...
          {/* Stats Cards */}
          <div className="relative lg:absolute lg:top-[806px] left-1/2 -translate-x-1/2 w-[96%] lg:w-[calc(100%-96px)] max-w-none mt-10 lg:mt-0 z-30 max-sm:mt-20">
                ...
                return (
                  <div
                    ...
                    className={`
                      ...
                      rounded-[8px] sm:rounded-[15px] shadow-[3px_5px_10px_0px_rgba(85,85,85,0.5)] lg:shadow-[10px_10px_30px_10px_#555555] overflow-hidden relative opacity-0 cursor-pointer transition-all duration-500 ease-in-out
                    `}
                    style={{
