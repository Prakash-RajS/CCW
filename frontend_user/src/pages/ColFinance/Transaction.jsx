...
//         if (txType.includes("deposit") || txType.includes("wallet topup") || txType.includes("topup")) {
//           displayName = "Wallet Top Up";
//         } else if (txType.includes("internal transfer")) {
//           // Show the other party's name/email
//           if (tx.to_user && tx.to_user !== userData?.email) {
//             displayName = tx.to_user;
//           } else if (tx.from_user && tx.from_user !== userData?.email) {
//             displayName = tx.from_user;
//           } else {
//             displayName = "Internal Transfer";
//           }
//         } else if (txType.includes("payment received")) {
//           displayName = tx.from_user || "Payment Received";
//         } else if (txType.includes("withdrawal")) {
//           displayName = "Withdrawal";
//         } else if (txType.includes("transfer")) {
//           displayName = tx.to_user || tx.from_user || "Transfer";
//         } else {
//           displayName = tx.collaborator_name || tx.recipient_name || "Transaction";
//         }

//         // Determine display type
//         let displayType = "Other";
//         if (txType.includes("deposit") || txType.includes("topup")) displayType = "Top Up";
//         else if (txType.includes("internal transfer") || txType.includes("payment received")) displayType = "Transfer";
...
//       case "Transfer": return "bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full text-[10px] md:text-xs font-medium";
...
//   // Pagination logic - with ellipsis (not showing all page numbers)
...
//   // Build page numbers with ellipsis (same as TransactionHistory)
...
//         <div className="hidden md:block absolute top-[140px] left-1/2 transform -translate-x-1/2 w-[1215px] z-20">
//           <button 
//             onClick={() => navigate(-1)} 
...
//         <div
//           className="relative z-10 w-[95%] md:w-[1215px] mt-0 md:mt-[197px] mx-auto opacity-100 shadow-[0px_4px_4px_0px_#00000040] bg-white min-h-[460px] rounded-xl md:rounded-none"
//         >
...
//           {/* Table Container - Larger table size */}
//           <div className="w-full mt-4 md:mt-[81px] px-4 md:px-10 pb-6 md:pb-8">
//             {loading ? (
...
//             ) : (
//               <>
//                 {/* Transactions Table - Larger/bigger table with same style as TransactionHistory */}
...
//                 {/* Modern Pagination - with ellipsis (not showing all page numbers) */}
//                 {totalPages > 1 && (
