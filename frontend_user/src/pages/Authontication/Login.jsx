...
const Login = () => { 
  ...
  // Track if auto-focus has been done to prevent multiple triggers
  ...
  // Check if email is valid (has @gmail.com)
  ...
  const handleEmailChange = (e) => {
    ...
    // Reset auto-focus flag when email changes
    if (value !== initialEmailRef.current) {
  ...
  // Auto-focus password field ONLY when email is valid (has @gmail.com)
  useEffect(() => {
    if (isEmailValid && !isLoading && passwordInputRef.current && !hasAutoFocusedRef.current) {
  ...
  const handlePasswordContainerClick = () => {
    if (!isLoading && passwordInputRef.current) {
      focusWithIOSWorkaround(passwordInputRef);
    }
  };
  ...
  const togglePasswordVisibility = () => {
    ...
    if (isSafari && passwordInputRef.current) {
  ...
  const handleLogin = async () => {
    ...
    if (emailError && emailError !== "Email not found. Please check your email address.") {
      return;
    }
    ...
    if (passwordError && passwordError !== "Invalid password. Please try again.") {
      return;
    }
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        } else if (response.data?.full_name && response.data.full_name.trim() !== '') {
      ...
      if (errorDetail === "email_not_found") {
        ...
        setEmailError("");
        setPasswordError("");
        const errorMessage = errorDetail || "An unexpected error occurred.";
    ...
    <div className="fixed inset-0 overflow-hidden">
      ...
      <div className="relative w-screen h-screen flex justify-center items-center p-4 sm:p-6 md:p-8">
        <div className="relative w-full max-w-[580px] rounded-[28px] border-[1.5px] border-white bg-white/70 shadow-[0_0_10px_0_#FFFFFF] flex flex-col items-center justify-center p-6 sm:p-8 md:p-10">
          ...
          <button
            onClick={handleBack}
            className="absolute top-3 left-3 sm:top-4 sm:left-4 md:top-5 md:left-5 
          ...
          >
            <svg 
              ...
              className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-4.5 md:w-4.5 text-white group-hover:scale-110 transition-transform duration-200" 
              fill="none" 
              viewBox="0 0 24 24" 
              stroke="currentColor"
            >
          ...
          <div className="w-full max-w-[500px] flex flex-col gap-2">
            <div className="w-full flex items-center justify-center">
              <h1
                className="text-[28px] sm:text-[32px] md:text-[34px] font-[700] trochut-font leading-[100%] text-center
            ...
            <div className="w-full flex flex-col items-center">
              <div className="w-full max-w-[400px] text-center space-y-1">
                <h2 className="text-[22px] sm:text-[24px] md:text-[26px] font-[500] poppins-font text-[#333333]">
                  Welcome back
                </h2>
                <p className="text-[12px] sm:text-[13px] md:text-[14px] font-[400] poppins-font text-[#3D1768]">
              ...
              <div className="w-full mt-3 sm:mt-4">
                <p className="text-[13px] sm:text-[14px] font-[400] poppins-font text-[#000000] mb-1.5">
                  Email
                </p>
                <div
                  className={`input-container w-full h-[44px] sm:h-[48px] rounded-[10px] flex items-center px-3 ${
              ...
              <div className="w-full mt-3 sm:mt-4">
                <div className="flex justify-between items-center mb-1.5">
                  <p className="text-[13px] sm:text-[14px] font-[400] poppins-font text-[#030303]">
                    Password
                  </p>
                ...
                >
                  <input
                    ...
                    spellCheck={false}
                    style={{
                      WebkitTextFillColor: "#00000080",
                      opacity: 1,
                      fontSize: '16px'
                    }}
                    className={`w-full bg-transparent outline-none text-[14px] sm:text-[15px] poppins-font text-[#030303] placeholder:text-[#00000080] ${
                ...
                <div className="mt-1.5 flex justify-end">
                  <Link
                    to="/forgot-password"
                    className="text-[11px] sm:text-[12px] md:text-[14px] poppins-font text-[#3D1768] hover:underline"
                  >
                   Forgot password?
                  </Link>
                </div>
              ...
              <button
                ...
                className="
                  ...
                  w-full max-w-[500px] h-[44px] sm:h-[48px]
                  rounded-[35px]
                  text-white poppins-font text-[14px] sm:text-[15px] font-medium
                  mt-5 sm:mt-6
              ...
              <div className="mt-3 text-center">
                <p className="text-[12px] sm:text-[14px] poppins-font text-[#030303]">
                  ...
                  <Link
                    to="/signup"
                    className="text-[#3D1768] font-medium hover:underline cursor-pointer"
                  >
                    Sign up
                  </Link>
                </p>
